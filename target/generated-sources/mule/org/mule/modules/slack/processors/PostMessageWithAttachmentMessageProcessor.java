...
/**
 * PostMessageWithAttachmentMessageProcessor invokes the {@link org.mule.modules.slack.SlackConnector#postMessageWithAttachment(java.lang.String, java.lang.String, java.lang.String, java.lang.String, org.mule.modules.slack.client.model.chat.attachment.ChatAttachment, org.mule.modules.slack.client.model.chat.attachment.Field, java.lang.Boolean)} method in {@link SlackConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    protected Object chatAttachment;
    protected ChatAttachment _chatAttachmentType;
    protected Object field;
    protected Field _fieldType;
     ...
     * @param value Value to set
     */
    public void setChatAttachment(Object value) {
        this.chatAttachment = value;
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final ChatAttachment _transformedChatAttachment = ((ChatAttachment) evaluateAndTransform(getMuleContext(), event, PostMessageWithAttachmentMessageProcessor.class.getDeclaredField("_chatAttachmentType").getGenericType(), null, chatAttachment));
            final Field _transformedField = ((Field) evaluateAndTransform(getMuleContext(), event, PostMessageWithAttachmentMessageProcessor.class.getDeclaredField("_fieldType").getGenericType(), null, field));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((SlackConnector) object).postMessageWithAttachment(_transformedMessage, _transformedChannelId, _transformedUsername, _transformedIconURL, _transformedChatAttachment, _transformedField, _transformedAsUser);
                }
    ...
    public Result<MetaData> getInputMetaData() {
        return new DefaultResult<MetaData>(new DefaultMetaData(getPojoOrSimpleModel(ChatAttachment.class)));
    }
